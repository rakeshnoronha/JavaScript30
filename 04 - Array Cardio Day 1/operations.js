...
const namesList = people.sort((a, b) => {
...
const inventorList = inventors.filter((inventor) =>
  inventor.year >= 1500 && inventor.year < 1600 ? 1 : ''
)
...
// const listStreets = Array.from(category.querySelectorAll('a'))

// const streetsss = listStreets
...
const totalVeh = data.reduce((total, item) => {
  console.log(item)
